...
#include "ssp_osal.h"
static SSP_OSAL_HANDLE _hLock;
#define LK_CREATE()     SSPOSAL_LockCreate()
#define LK_DESTROY(h)   SSPOSAL_LockDestroy(h)
#define LK_LOCK(h)      SSPOSAL_LockGet(h, 5000)
#define LK_UNLOCK(h)    SSPOSAL_LockPut(h)
